...
import com.example.administrator.board.main.UpdateActivity;
...
public class qna_DetailActivity extends AppCompatActivity {
    ...
    private ListView lv_qnacomment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_qnacomment = (ListView) findViewById(R.id.lv_qnacomment);
        ...
        new HttpqnaCommnetList().execute(strnumber, "1");

        // 데이터 생성
        list = new ArrayList<ModelBoard_Article_Comment>();
        adapter = new CommnetAdapterEx(this, R.layout.acitivity_qna_list_commnet, R.id.tv_commentmemo, list);
        lv_qnacomment.setAdapter(adapter);

        lv_qnacomment.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if(lastItem == totalItemCount) {
                    ...
                    if( !calling ) {
                        ...
                        new HttpqnaCommnetList().execute(a, a);
                    }
                }
            }
        });
                ...
                alert_confirm.setMessage("삭제하시겠습니까?").setCancelable(false).setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                int number = r + 1;
                                String strnumber = String.valueOf(number);
                                new qna_DetailActivity.HttpGetArticleno().execute(number);
                                finish();
                            }
    ...
    public class HttpDetail extends AsyncTask<Integer, Integer, ModelBoard_Article> {
        ...
        protected void onPreExecute() {
            ...
            waitDlg = new ProgressDialog( qna_DetailActivity.this );
        ...
        protected ModelBoard_Article doInBackground(Integer... params) {
            ...
            ModelBoard_Article result = new HttpBoard().getBoard_Article_Detail1(position);
            return result;
        }
    ...
    private class HttpqnaCommnetList extends AsyncTask<String, String, List<ModelBoard_Article_Comment>> {
    ...
    private class HttpqnaCommnetinsert extends AsyncTask<String, String, String> {
    ...
    private class HttpqnaBoardDelete extends AsyncTask<String, String, String> {
    ...
    public class HttpGetArticleno extends AsyncTask<Integer, Integer, ModelBoard_Article> {
        ...
        protected ModelBoard_Article doInBackground(Integer... params) {
            ...
            ModelBoard_Article result = new HttpBoard().getBoard_Article_Articleno1(position);
            return result;
        }
        ...
        protected void onPostExecute(ModelBoard_Article result) {
            ...
            if (result != null) {
                ...
                new HttpqnaBoardDelete().execute(articleno);
            }
        }
    }
    ...
    public class HttpGetArticleno_comment extends AsyncTask<Integer, Integer, ModelBoard_Article> {
        ...
        protected void onPostExecute(ModelBoard_Article result) {
            ...
            if (result != null) {
                ...
                new HttpqnaCommnetinsert().execute(articleno, userid, commentmemo);
