...
public class qna_BoardActivity extends AppCompatActivity {

    private ListView lv_qnaboard = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_qnaboard = (ListView) findViewById(R.id.lv_qnaboard);
        ...
        adapter = new BoardAdapterEx(this, R.layout.acitivity_qna_list, R.id.tv_title, list);
        lv_qnaboard.setAdapter(adapter);

        lv_qnaboard.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if(lastItem == totalItemCount) {
                    ...
                    if( !calling ) {
                        ...
                        new HttpqnaBoardList().execute(adapter.getCount(), adapter.getCount()+2);
                    }
                }
            }
        });
        ...
        img_writer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(qna_BoardActivity.this, qna_WritingActivity.class);
                intent.putExtra("data", modelUser);
                startActivityForResult(intent,10000);
            }
        });

        lv_qnaboard.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(qna_BoardActivity.this, qna_DetailActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        new HttpqnaBoardList().execute(adapter.getCount(), adapter.getCount());
    }



    public class HttpqnaBoardList extends AsyncTask<Integer, Integer, List<ModelBoard_Article>> {
        ...
        protected void onPreExecute() {
            ...
            waitDlg = new ProgressDialog( qna_BoardActivity.this );
        ...
        protected List<ModelBoard_Article> doInBackground(Integer... params) {
            ...
            List<ModelBoard_Article> list = new HttpBoard().getBoard_ArticleList1(1);
            return list;
