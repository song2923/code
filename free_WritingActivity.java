...
public class free_WritingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_writing_free);
        ...
        btn_cancle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(free_WritingActivity.this, free_BoardActivity.class);
    ...
    public class HttpRequestAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            waitDlg = new ProgressDialog(free_WritingActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            String result = new HttpBoard().insertBoard_Article2(userid, title, content);
            return result;
        }
